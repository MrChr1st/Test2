...
from services.report_stats import (
    ensure_stats_scheduler_started,
    log_event_exchange_opened,
    log_event_paid,
    log_event_qr_requested,
    log_event_request_created,
    log_event_wallet_urgent,
)
...
async def exchange_start(message: Message, db, state: FSMContext):
    ...
    await ensure_stats_scheduler_started()
    log_event_exchange_opened(
